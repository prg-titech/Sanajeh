...
for x in range(itr):
    ...
    PyAllocator.parallel_do(Body, Body.initialize_merge)
    PyAllocator.parallel_do(Body, Body.prepare_merge)
    PyAllocator.parallel_do(Body, Body.update_merge)
    PyAllocator.parallel_do(Body, Body.delete_merged)
