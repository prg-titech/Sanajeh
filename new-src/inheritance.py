...
from call_graph import VariableNode, ast_to_call_graph_type
...
# TODO: replace with FunctionNode
class FunctionData:
    def __init__(self):
        self.name = ""
        self.astNode = None
...
# TODO: replace with VariableNode
class VariableData:
    def __init__(self):
        self.name = ""
        self.astNode = None
...
class ClassInspectorMain:
    ...
    def Start(self):
        ...
        # Do not process if there is no multiple inheritance
        mult_inheritance = False
        for class_node in graph.classNodes:
            if len(class_node.parents) > 1:
                mult_inheritance = True
                break
