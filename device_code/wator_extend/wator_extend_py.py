    ...
    def decide(self):
        if self.neighbor_request_[4]:
            ...
            if (num_candidates > 0):
                ...
                __auto_v0: Agent = self.neighbors_[candidates[selected_index]].agent()
                __auto_v0.set_new_position(self)
